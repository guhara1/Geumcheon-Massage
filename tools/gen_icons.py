...
def icon(size, pad_ratio=.14, maskable=False):
    ...
    d.text((size/2, size/2 - inner*0.04), "V", font=f, fill=(26, 18, 8), anchor="mm")
    return base
...
fb, fs = kr_font(72), kr_font(34)
d.text((80, 250), "금천 VIP 마사지", font=fb, fill=(243, 243, 245))
d.text((82, 360), "금천 출장마사지 · 홈타이 예약 안내 · 연중무휴 24시간", font=fs, fill=(154, 154, 163))
mark = rounded(grad(120), 26)
ov.alpha_composite(mark, (80, 110))
md = ImageDraw.Draw(ov)
md.text((140, 158), "V", font=font(70), fill=(26, 18, 8), anchor="mm")
